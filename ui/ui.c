...
///////////////////// VARIABLES ////////////////////
lv_anim_t * craspeed_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * valuechanhe_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * craspeed_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_playback_time(&PropertyAnimation_0, 2500);
...
lv_anim_t * valuechanhe_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_deleted_cb(&PropertyAnimation_0, _ui_anim_callback_free_user_data);
    lv_anim_set_playback_time(&PropertyAnimation_0, 2500);
    lv_anim_set_playback_delay(&PropertyAnimation_0, 255);
    lv_anim_set_repeat_count(&PropertyAnimation_0, LV_ANIM_REPEAT_INFINITE);
    lv_anim_set_repeat_delay(&PropertyAnimation_0, 0);
